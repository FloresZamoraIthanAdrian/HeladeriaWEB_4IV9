                ...
                <div class="producto">
                    <div style="margin: 22px; background: rgba(219,70,155,0.8); border: 2px solid black; border-radius: 25px; padding: 5px;">
                        ...
                        <table>
                            ...
                            <th>
                            <td>
                                <a style='text-decoration: none;' href="EditarHelado.jsp?id=<%= h.getId()%>" name="" class="boton">Editar</a>
                            </td>
                            </th>
                            <th>
                            <td>
                                <a style='text-decoration: none;' href="BorrarHelado?id=<%= h.getId()%>" name="" class="boton">Borrar</a>
                            </td>
                            </th>
                            </thead>
                        </table>
